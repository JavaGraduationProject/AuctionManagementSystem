...
<div style="padding: 10px" class="admin-content">
    ...
    List<Map> list = Query.make("guanyu").where(where).order(orderby + " " + sort).page(15);
    %>


    <div class="panel panel-default">
        <div class="panel-heading">
            <span class="module-name"> 关于 </span>
            <span>列表</span>
        </div>
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr id="<%= map.get("id") %>" pid="">
                            ...
                            <td align="center">
                                <a href="guanyu_updt.jsp?id=<%= map.get("id") %>">编辑</a>

                                <a href="guanyu.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('确定要删除？')">删除</a>
                                <!--qiatnalijne-->
                            </td>
                        </tr>
                        <%} %>
