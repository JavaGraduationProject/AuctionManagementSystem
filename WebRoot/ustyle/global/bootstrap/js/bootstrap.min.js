        ...
        function b(b) {
            (b && 3 === b.which) ||
                ...
                a(f).each(function () {
                    ...
                    e.hasClass("open") &&
                        ((b && "click" == b.type && /input|textarea/i.test(b.target.tagName) && a.contains(e[0], b.target)) ||
                ...
                if (!e.is(".disabled, :disabled")) {
                    ...
                    if ((b(), !g)) {
                        "ontouchstart" in document.documentElement &&
                            ...
                            a(document.createElement("div")).addClass("dropdown-backdrop").insertAfter(a(this)).on("click", b);
