    ...
    n.extend({
        ...
        ajax: function (a, b) {
            ...
            (i = n.event && k.global),
                ...
                v.setRequestHeader(
                    "Accept",
                    k.dataTypes[0] && k.accepts[k.dataTypes[0]] ? k.accepts[k.dataTypes[0]] + ("*" !== k.dataTypes[0] ? ", " + nc + "; q=0.01" : "") : k.accepts["*"]
                );
    ...
    n.ajaxSetup({
        ...
        n.ajaxPrefilter("json jsonp", function (b, c, d) {
            var e,
                ...
                h =
                    b.jsonp !== !1 &&
                    (Gc.test(b.url) ? "url" : "string" == typeof b.data && !(b.contentType || "").indexOf("application/x-www-form-urlencoded") && Gc.test(b.data) && "data");
