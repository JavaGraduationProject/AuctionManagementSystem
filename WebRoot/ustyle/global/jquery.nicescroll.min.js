    ...
    var m = window.MutationObserver || window.WebKitMutationObserver || !1,
        ...
        w = function () {
            ...
            (t.hastransform = 0 != t.trstyle),
                ...
                (t.transitionend = !1);
            for (
                var r = ["transition", "webkitTransition", "MozTransition", "OTransition", "OTransition", "msTransition", "KhtmlTransition"],
        ...
        v = function (e, o) {
            ...
            function p(e, o, t, r) {
                v._bind(
                    ...
                    function (r) {
                        ...
                        return (
                            "mousewheel" == o ? ((i.deltaY = (-1 / 40) * r.wheelDelta), r.wheelDeltaX && (i.deltaX = (-1 / 40) * r.wheelDeltaX)) : (i.deltaY = r.detail),
                            t.call(e, i)
                        );
                    },
                    r
            ...
            function g(e, o, t) {
                ...
                if (
                    (0 == e.deltaMode
                        ? ((r = -Math.floor(e.deltaX * (v.opt.mousescrollstep / 54))), (i = -Math.floor(e.deltaY * (v.opt.mousescrollstep / 54))))
                        : 1 == e.deltaMode && ((r = -Math.floor(e.deltaX * v.opt.mousescrollstep)), (i = -Math.floor(e.deltaY * v.opt.mousescrollstep))),
            ...
            (this.canhwscroll = x.hastransform && v.opt.hwacceleration),
                ...
                x.cantouch && x.iswebkit && !x.isios && !x.isandroid && ((this.istouchcapable = !0), (x.cantouch = !1)),
            ...
            (this.getOffset = function () {
                ...
                (this.updateScrollBar = function (e) {
                    if (v.ishwscroll) v.rail.css({ height: v.win.innerHeight() }), v.railh && v.railh.css({ width: v.win.innerWidth() });
                    else {
                        var o = v.getOffset(),
                        ...
                        if (
                            (r && (r.top && (t.top += r.top), v.rail.align && r.left && (t.left += r.left)),
                            v.locked || v.rail.css({ top: t.top, left: t.left, height: e ? e.h : v.win.innerHeight() }),
                            v.zoom && v.zoom.css({ top: t.top + 1, left: 1 == v.rail.align ? t.left - 20 : t.left + v.rail.width + 4 }),
                            v.railh && !v.locked)
                        ) {
                        ...
                        o
                            ? ((r = t ? v.doScrollLeft : v.doScrollTop),
                              (n = t
                                  ...
                                  : (e.pageY - v.rail.offset().top - v.cursorheight / 2) * v.scrollratio.y),
                              r(n))
                ...
                (this.init = function () {
                    ...
                    function o() {
                        ...
                        if (
                            ((v.forcescreen = !0),
                            v.isiframe &&
                                ((v.iframe = { doc: a(e), html: v.doc.contents().find("html")[0], body: v.doc.contents().find("body")[0] }),
                        ...
                        v.lazyResize(30),
                            ...
                            x.isios && v.haswrapper && v.css(a(e.body), { "-webkit-transform": "translate3d(0,0,0)" }),
                            ...
                            (x.cantouch || v.opt.touchbehavior) &&
                                ...
                                v.opt.grabcursorenabled && x.cursorgrabvalue && v.css(a(e.body), { cursor: x.cursorgrabvalue })),
                    ...
                    if (
                        (x.hasmstouch && v.css(v.ispage ? a("html") : v.win, { "-ms-touch-action": "none" }),
                        (v.zindex = "auto"),
                        (v.zindex = v.ispage || "auto" != v.opt.zindex ? v.opt.zindex : c() || "auto"),
                        ...
                        v.ispage && (t = v.haswrapper ? v.win : v.doc),
                            ...
                            v.ispage &&
                                ...
                                ("BODY" == v.doc[0].nodeName
                                    ...
                                    : "HTML" == v.doc[0].nodeName && v.css(a("body"), { "overflow-y": "hidden" })),
                            !x.isios || v.ispage || v.haswrapper || v.css(a("body"), { "-webkit-overflow-scrolling": "touch" });
                        ...
                        d.append(s),
                            (d.width = Math.max(parseFloat(v.opt.cursorwidth), s.outerWidth()) + v.opt.railpadding.left + v.opt.railpadding.right),
                            d.css({ width: d.width + "px", zIndex: v.zindex, background: v.opt.background, cursor: "default" }),
                            (d.visibility = !0),
                            (d.scrollable = !0),
                        ...
                        if (
                            (!v.opt.boxzoom ||
                                ...
                                x.cantouch &&
                                    ...
                                    ((v.ongesturezoom = function (e) {
                                        return e.scale > 1.5 && v.doZoomIn(e), e.scale < 0.8 && v.doZoomOut(e), v.cancelEvent(e);
                                    }),
                            ...
                            w.attr("id", v.id + "-hr"),
                                ...
                                (w.height = Math.max(parseFloat(v.opt.cursorwidth), s.outerHeight())),
                                w.css({ height: w.height + "px", zIndex: v.zindex, background: v.opt.background }),
                                w.append(s),
                                (w.visibility = !0),
                                (w.scrollable = !0),
                        ...
                        if (v.ispage)
                            d.css({ position: "fixed", top: "0px", height: "100%" }),
                                ...
                                v.body.append(d),
                                v.railh && (w.css({ position: "fixed", left: "0px", width: "100%" }), w.css(w.align ? { bottom: "0px" } : { top: "0px" }), v.body.append(w));
                        else {
                            if (v.ishwscroll) {
                                "static" == v.win.css("position") && v.css(v.win, { position: "relative" });
                                var y = "HTML" == v.win[0].nodeName ? v.body : v.win;
                                v.zoom && (v.zoom.css({ position: "absolute", top: 1, right: 0, "margin-right": d.width + 4 }), y.append(v.zoom)),
                                    d.css({ position: "absolute", top: 0 }),
                                    d.css(d.align ? { right: 0 } : { left: 0 }),
                                    y.append(d),
                                    w && (w.css({ position: "absolute", left: 0, bottom: 0 }), w.css(w.align ? { bottom: 0 } : { top: 0 }), y.append(w));
                            } else {
                                v.isfixed = "fixed" == v.win.css("position");
                                var S = v.isfixed ? "fixed" : "absolute";
                                v.isfixed || (v.viewport = v.getViewport(v.win[0])),
                                    v.viewport &&
                                        ((v.body = v.viewport), 0 == /fixed|relative|absolute/.test(v.viewport.css("position")) && v.css(v.viewport, { position: "relative" })),
                                    d.css({ position: S }),
                            ...
                            x.isios && v.css(v.win, { "-webkit-tap-highlight-color": "rgba(0,0,0,0)", "-webkit-touch-callout": "none" }),
                                x.isie && v.opt.disableoutline && v.win.attr("hideFocus", "true"),
                                x.iswebkit && v.opt.disableoutline && v.win.css({ outline: "none" });
                        }
                        if (
                            (v.opt.autohidemode === !1
                                ? ((v.autohidedom = !1), v.rail.css({ opacity: v.opt.cursoropacitymax }), v.railh && v.railh.css({ opacity: v.opt.cursoropacitymax }))
                                ...
                                ? ((v.autohidedom = a().add(v.rail)),
                                  ...
                                  v.railh && x.isie8 && (v.autohidedom = v.autohidedom.add(v.cursorh)))
                                : "scroll" == v.opt.autohidemode
                                ? ((v.autohidedom = a().add(v.rail)), v.railh && (v.autohidedom = v.autohidedom.add(v.railh)))
                                : "cursor" == v.opt.autohidemode
                                ? ((v.autohidedom = a().add(v.cursor)), v.railh && (v.autohidedom = v.autohidedom.add(v.cursorh)))
                                : "hidden" == v.opt.autohidemode && ((v.autohidedom = !1), v.hide(), (v.locked = !1)),
                            x.isie9mobile)
                        ) {
                            (v.scrollmom = new b(v)),
                            ...
                            if (x.cantouch || v.istouchcapable || v.opt.touchbehavior || x.hasmstouch) {
                                (v.scrollmom = new b(v)),
                                    (v.ontouchstart = function (e) {
                                        ...
                                        if (((v.hasmoving = !1), !v.locked)) {
                                            ...
                                            if (
                                                ...
                                                (v.rail.drag.ck =
                                                    !v.rail.scrollable && v.railh.scrollable ? (l > 0 ? "v" : !1) : v.rail.scrollable && !v.railh.scrollable && c > 0 ? "h" : !1),
                                    ...
                                    (v.ontouchend = function (e) {
                                        return e.pointerType && 2 != e.pointerType && "touch" != e.pointerType
                                            ? !1
                                            : v.rail.drag &&
                                              2 == v.rail.drag.pt &&
                                              (v.scrollmom.doMomentum(),
                                              (v.rail.drag = !1),
                                              v.hasmoving && ((v.lastmouseup = !0), v.hideCursor(), x.hasmousecapture && document.releaseCapture(), !x.cantouch))
                                            ? v.cancelEvent(e)
                                            : void 0;
                                    });
                                    ...
                                    if (v.rail.drag && 2 == v.rail.drag.pt) {
                                        ...
                                        (v.hasmoving = !0),
                                            v.preventclick &&
                                                ...
                                                ((v.preventclick.click = v.preventclick.tg.onclick || !1), (v.preventclick.tg.onclick = v.onpreventclick));
                                        ...
                                        if (
                                            (v.ishwscroll && v.opt.bouncescroll
                                                ? 0 > u
                                                    ? (u = Math.round(u / 2))
                                                    : u > v.page.maxh && (u = v.page.maxh + Math.round((u - v.page.maxh) / 2))
                                            ...
                                            v.ishwscroll && v.opt.bouncescroll
                                                ? 0 > h
                                                    ? (h = Math.round(h / 2))
                                                    : h > v.page.maxw && (h = v.page.maxw + Math.round((h - v.page.maxw) / 2))
                                                : (0 > h && ((h = 0), (c = 0)), h > v.page.maxw && ((h = v.page.maxw), (c = 0)));
                                        }
                                        var p = !1;
                                        ...
                                        if (
                                            (v.synched("touchmove", function () {
                                                v.rail.drag &&
                                                    ...
                                                    v.railh && v.railh.scrollable ? (v.setScrollLeft(h), v.showCursor(u, h)) : v.showCursor(u),
                            ...
                            (v.onmousedown = function (e, o) {
                                if (!v.rail.drag || 1 == v.rail.drag.pt) {
                                    ...
                                    return (
                                        ...
                                        v.isiframe && !x.hasmousecapture && ((v.saved.csspointerevents = v.doc.css("pointer-events")), v.css(v.doc, { "pointer-events": "none" })),
                                        (v.hasmoving = !1),
                                        v.cancelEvent(e)
                                    );
                                }
                                        ...
                                        return (
                                            v.synched("mousemove", function () {
                                                v.rail.drag &&
                                                    ...
                                                    (v.showCursor(),
                                                    v.rail.drag.hr
                                                        ? v.doScrollLeft(Math.round(v.scroll.x * v.scrollratio.x), v.opt.cursordragspeed)
                                ...
                                x.cantouch || v.opt.touchbehavior
                                    ? ((v.onpreventclick = function (e) {
                                      ...
                                      v.opt.grabcursorenabled &&
                                          x.cursorgrabvalue &&
                                          (v.css(v.ispage ? v.doc : v.win, { cursor: x.cursorgrabvalue }), v.css(v.rail, { cursor: x.cursorgrabvalue })))
                                    : ((v.hasTextSelected =
                                ...
                                (v.opt.cursordragontouch || (!x.cantouch && !v.opt.touchbehavior)) &&
                                ...
                                x.cantouch || v.opt.touchbehavior
                                    ? (v.bind(x.hasmousecapture ? v.win : document, "mouseup", v.ontouchend),
                                    ...
                                    : (v.bind(x.hasmousecapture ? v.win : document, "mouseup", v.onmouseup),
                                ...
                                v.opt.enablemousewheel &&
                                    (v.isiframe || v.bind(x.isie && v.ispage ? document : v.win, "mousewheel", v.onmousewheel),
                            ...
                            v.ispage ||
                                ...
                                (m !== !1
                                    ? ((v.observer = new m(function (e) {
                                      ...
                                      v.observer.observe(v.win[0], { childList: !0, characterData: !1, attributes: !0, subtree: !1 }),
                                      ...
                                      v.observerremover.observe(v.win[0].parentNode, { childList: !0, characterData: !1, attributes: !1, subtree: !1 }))
                ...
                (this.showCursor = function (e, o) {
                    v.cursortimeout && (clearTimeout(v.cursortimeout), (v.cursortimeout = 0)),
                        v.rail &&
                            (v.autohidedom && (v.autohidedom.stop().css({ opacity: v.opt.cursoropacitymax }), (v.cursoractive = !0)),
                            (v.rail.drag && 1 == v.rail.drag.pt) ||
                                (void 0 !== e && e !== !1 && (v.scroll.y = Math.round((1 * e) / v.scrollratio.y)),
                                void 0 !== o && (v.scroll.x = Math.round((1 * o) / v.scrollratio.x))),
                            v.cursor.css({ height: v.cursorheight, top: v.scroll.y }),
                            v.cursorh &&
                                (v.cursorh.css(
                                    !v.rail.align && v.rail.visibility ? { width: v.cursorwidth, left: v.scroll.x + v.rail.width } : { width: v.cursorwidth, left: v.scroll.x }
                                ),
                                (v.cursoractive = !0)),
                            ...
                            ((v.hasmousefocus && "leave" == v.opt.autohidemode) ||
                                (v.cursortimeout = setTimeout(function () {
                                    (v.rail.active && v.showonmouseevent) ||
                                        (v.autohidedom.stop().animate({ opacity: v.opt.cursoropacitymin }),
                                        v.zoom && v.zoom.stop().animate({ opacity: v.opt.cursoropacitymin }),
                                        (v.cursoractive = !1)),
                                        (v.cursortimeout = 0);
                ...
                (this.onResize = function (e, o) {
                    ...
                    if (
                        ((v.view = { w: v.ispage ? v.win.width() : parseInt(v.win[0].clientWidth), h: v.ispage ? v.win.height() : parseInt(v.win[0].clientHeight) }),
                    ...
                    if (
                        (0 == v.page.maxh
                            ? (v.hideRail(), (v.scrollvaluemax = 0), (v.scroll.y = 0), (v.scrollratio.y = 0), (v.cursorheight = 0), v.setScrollTop(0), (v.rail.scrollable = !1))
                            : (v.rail.scrollable = !0),
                        0 == v.page.maxw
                            ? (v.hideRailHr(), (v.scrollvaluemaxw = 0), (v.scroll.x = 0), (v.scrollratio.x = 0), (v.cursorwidth = 0), v.setScrollLeft(0), (v.railh.scrollable = !1))
                    ...
                    v.hidden || v.visibility ? v.hidden || v.railh.visibility || v.showRailHr() : v.showRail().showRailHr(),
                        ...
                        v.railh &&
                            ((v.railh.width = v.page.maxh > 0 ? v.view.w - v.rail.width : v.view.w), (v.scrollvaluemaxw = v.railh.width - v.cursorwidth - v.cursorh.wborder)),
                ...
                (this.onmousewheel = function (e) {
                    if (!v.wheelprevented) {
                        ...
                        var o = +new Date(),
                            t = !1;
                        if (
                            (v.opt.preservenativescrolling && v.checkarea + 600 < o && ((v.nativescrollingarea = v.isScrollable(e)), (t = !0)),
                            (v.checkarea = o),
                ...
                (this.onmousewheelhr = function (e) {
                    if (!v.wheelprevented) {
                        ...
                        return (
                            v.opt.preservenativescrolling && v.checkarea + 600 < o && ((v.nativescrollingarea = v.isScrollable(e)), (t = !0)),
                            (v.checkarea = o),
                            v.nativescrollingarea ? !0 : v.locked ? v.cancelEvent(e) : g(e, !0, t)
                        );
                    }
                }),
                (this.stop = function () {
                        ...
                        ? ((this.prepareTransition = function (e, o) {
                          ...
                          (this.doScrollPos = function (e, o, t) {
                              var r = v.getScrollTop(),
                                  i = v.getScrollLeft();
                              return (
                                  ((v.newscrolly - r) * (o - r) < 0 || (v.newscrollx - i) * (e - i) < 0) && v.cancelScroll(),
                                      ...
                                      : ((v.newscrolly = o),
                                        ...
                                        v.timer
                                            ...
                                            : void (v.timer = setTimeout(function () {
                                                  ...
                                                  if (
                                                      (v.newscrollspeed && v.newscrollspeed <= 1 && (s *= v.newscrollspeed),
                                                      ...
                                                      x.transitionend
                                                          ? v.scrollendtrapped || ((v.scrollendtrapped = !0), v.bind(v.doc, x.transitionend, v.onScrollTransitionEnd, !1))
                                                          : (v.scrollendtrapped && clearTimeout(v.scrollendtrapped), (v.scrollendtrapped = setTimeout(v.onScrollTransitionEnd, s)));
                                                      var a = t,
                                                          c = r;
                                                      (v.timerscroll = {
                                                          bz: new BezierClass(a, v.newscrolly, s, 0, 0, 0.58, 1),
                                                          bh: new BezierClass(c, v.newscrollx, s, 0, 0, 0.58, 1),
                                                      }),
                                                          v.cursorfreezed ||
                          ...
                          (this.onScrollTransitionEnd = function () {
                              ...
                              return (
                                  ...
                                  e != v.newscrolly || o != v.newscrollx
                                      ...
                                      : (v.onscrollend && v.scrollrunning && v.triggerScrollEnd(), void (v.scrollrunning = !1))
                              );
                          }))
                        : ((this.doScrollLeft = function (e, o) {
                              var t = v.scrollrunning ? v.newscrolly : v.getScrollTop();
                              ...
                              function r() {
                                  ...
                                  2 == e
                                      ? ((v.timer = 0),
                                        ...
                                        i != v.newscrollx || o != v.newscrolly ? v.doScrollPos(i, o) : v.onscrollend && v.triggerScrollEnd())
                                      : (v.timer = d(r) || 1);
                              }
                ...
                (this.doZoomIn = function (e) {
                    if (!v.zoomactive) {
                        ...
                        (v.zoomrestore.style.width = v.win.css("width")),
                            ...
                            v.win.css({ position: x.isios4 ? "absolute" : "fixed", top: 0, left: 0, "z-index": l + 100, margin: "0px" });
                        var n = v.win.css("backgroundColor");
                        return (
                            ("" == n || /transparent|rgba\(0, 0, 0, 0\)|rgba\(0,0,0,0\)/.test(n)) && v.win.css("backgroundColor", "#fff"),
                ...
                (this.resizeZoom = function () {
                    if (v.zoomactive) {
                        var e = v.getScrollTop();
                        v.win.css({ width: a(window).width() - v.zoomrestore.padding.w + "px", height: a(window).height() - v.zoomrestore.padding.h + "px" }),
                            v.onResize(),
                    ...
                    if (c || d) {
                        ...
                        var p = o.lastscrollx,
                            ...
                            f = function () {
                                ...
                                o.speedx && ((p = Math.floor(o.lastscrollx - o.speedx * (1 - o.demulxy))), (o.lastscrollx = p), (0 > p || p > l) && (e = 0.1)),
                                    o.speedy && ((m = Math.floor(o.lastscrolly - o.speedy * (1 - o.demulxy))), (o.lastscrolly = m), (0 > m || m > s) && (e = 0.1)),
