...
<div style="padding: 10px" class="admin-content">
    ...
    List<Map> list = Query.make("jingpai").where(where).order(orderby + " " + sort).page(15);
    %>


    <div class="panel panel-default">
        <div class="panel-heading">
            <span class="module-name"> 竞拍 </span>
            <span>列表</span>
        </div>
            ...
            <div class="pa10 bg-warning">
                <form class="form-inline" id="formSearch" action="?">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control class_fenlei13" data-value="<%= request.getParameter("fenlei") !=null ? request.getParameter("fenlei") : "" %>" id="fenlei" name="fenlei">
                ...
                <table width="100%" border="1" class="table table-list table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr id="<%= map.get("id") %>" pid="">
                            ...
                            <td><% Map mapfenlei12 = new CommDAO().find("SELECT fenleiming,id FROM fenlei where id='" + map.get("fenlei") + "'"); %>
<%= mapfenlei12.get("fenleiming") %></td>
                            <td><%= map.get("qipaijia") %></td>
                            <td><%= map.get("faburen") %></td>
                            <td><%= map.get("jingpaijia") %></td>
                            <td><%= map.get("jingpairen") %></td>
                            <td align="center">
                                <a href="jingpai_updt.jsp?id=<%= map.get("id") %>">编辑</a>

                                <a href="jingpai.jsp?a=delete&id=<%= map.get("id") %>" onclick="return confirm('确定要删除？')">删除</a>
                                <!--qiatnalijne-->
                            </td>
                        </tr>
                        <%} %>
