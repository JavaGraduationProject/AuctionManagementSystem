                ...
                <form action="dingdan.jsp?a=insert" method="post" name="form1" id="form1">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10"><% Map mapfenlei21 = new CommDAO().find("SELECT fenleiming,id FROM fenlei where id='" + readMap.get("fenlei") + "'"); %>
<%= mapfenlei21.get("fenleiming") %><input type="hidden" id="fenlei" name="fenlei" value="<%= Info.html(readMap.get("fenlei")) %>" /></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
